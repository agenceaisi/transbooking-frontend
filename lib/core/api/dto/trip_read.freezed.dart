...
/// @nodoc
abstract mixin class $TripReadCopyWith<$Res>  {
  factory $TripReadCopyWith(TripRead value, $Res Function(TripRead) _then) = _$TripReadCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$TripReadCopyWithImpl<$Res>
    implements $TripReadCopyWith<$Res> {
  _$TripReadCopyWithImpl(this._self, this._then);

  final TripRead _self;
  final $Res Function(TripRead) _then;
...
/// Adds pattern-matching-related methods to [TripRead].
extension TripReadPatterns on TripRead {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _TripRead value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _TripRead() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _TripRead value)  $default,){
final _that = this;
switch (_that) {
case _TripRead():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _TripRead value)?  $default,){
final _that = this;
switch (_that) {
case _TripRead() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$TripReadCopyWith<_TripRead> get copyWith => __$TripReadCopyWithImpl<_TripRead>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$TripReadToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TripRead&&(identical(other.id, id) || other.id == id)&&(identical(other.route, route) || other.route == route)&&(identical(other.routeLabel, routeLabel) || other.routeLabel == routeLabel)&&(identical(other.originCity, originCity) || other.originCity == originCity)&&(identical(other.destinationCity, destinationCity) || other.destinationCity == destinationCity)&&(identical(other.vehicle, vehicle) || other.vehicle == vehicle)&&(identical(other.vehicleRegistration, vehicleRegistration) || other.vehicleRegistration == vehicleRegistration)&&(identical(other.departureTime, departureTime) || other.departureTime == departureTime)&&(identical(other.arrivalTime, arrivalTime) || other.arrivalTime == arrivalTime)&&(identical(other.price, price) || other.price == price)&&(identical(other.availableSeats, availableSeats) || other.availableSeats == availableSeats)&&(identical(other.status, status) || other.status == status)&&(identical(other.statusDisplay, statusDisplay) || other.statusDisplay == statusDisplay)&&(identical(other.company, company) || other.company == company)&&(identical(other.companyName, companyName) || other.companyName == companyName)&&(identical(other.companySigle, companySigle) || other.companySigle == companySigle)&&(identical(other.companyRating, companyRating) || other.companyRating == companyRating)&&(identical(other.isDirect, isDirect) || other.isDirect == isDirect)&&(identical(other.stopsCount, stopsCount) || other.stopsCount == stopsCount)&&(identical(other.durationMinutes, durationMinutes) || other.durationMinutes == durationMinutes)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}
...
/// @nodoc
abstract mixin class _$TripReadCopyWith<$Res> implements $TripReadCopyWith<$Res> {
  factory _$TripReadCopyWith(_TripRead value, $Res Function(_TripRead) _then) = __$TripReadCopyWithImpl;
@override @useResult
$Res call({
 int id, int route,@JsonKey(name: 'route_label') String routeLabel,@JsonKey(name: 'origin_city') String originCity,@JsonKey(name: 'destination_city') String destinationCity, int vehicle,@JsonKey(name: 'vehicle_registration') String vehicleRegistration,@JsonKey(name: 'departure_time') DateTime departureTime,@JsonKey(name: 'arrival_time') DateTime? arrivalTime, String price,@JsonKey(name: 'available_seats') int? availableSeats, StatusF60Enum? status,@JsonKey(name: 'status_display') String statusDisplay, int company,@JsonKey(name: 'company_name') String companyName,@JsonKey(name: 'company_sigle') String companySigle,@JsonKey(name: 'company_rating') double? companyRating,@JsonKey(name: 'is_direct') bool isDirect,@JsonKey(name: 'stops_count') int stopsCount,@JsonKey(name: 'duration_minutes') int durationMinutes,@JsonKey(name: 'created_at') DateTime createdAt,@JsonKey(name: 'updated_at') DateTime updatedAt
});
...
/// @nodoc
class __$TripReadCopyWithImpl<$Res>
    implements _$TripReadCopyWith<$Res> {
  __$TripReadCopyWithImpl(this._self, this._then);

  final _TripRead _self;
  final $Res Function(_TripRead) _then;
