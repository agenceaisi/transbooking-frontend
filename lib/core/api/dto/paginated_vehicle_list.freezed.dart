...
mixin _$PaginatedVehicleList {
 ...
 int get count; String? get next; String? get previous; List<Vehicle> get results;
...
@useResult
$Res call({
 int count, String? next, String? previous, List<Vehicle> results
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int count,  String? next,  String? previous,  List<Vehicle> results)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PaginatedVehicleList() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int count,  String? next,  String? previous,  List<Vehicle> results)  $default,) {final _that = this;
switch (_that) {
case _PaginatedVehicleList():
return $default(_that.count,_that.next,_that.previous,_that.results);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int count,  String? next,  String? previous,  List<Vehicle> results)?  $default,) {final _that = this;
switch (_that) {
case _PaginatedVehicleList() when $default != null:
return $default(_that.count,_that.next,_that.previous,_that.results);case _:
  return null;
...
class _PaginatedVehicleList implements PaginatedVehicleList {
  const _PaginatedVehicleList({required this.count, this.next, this.previous, required final  List<Vehicle> results}): _results = results;
...
@override List<Vehicle> get results {
