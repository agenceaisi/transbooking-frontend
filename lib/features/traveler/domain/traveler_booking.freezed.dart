...
mixin _$TravelerBooking {
 ...
 int get id; String get ticketNumber; String get originCity; String get destinationCity;/// Nom de la compagnie (via `trip.company_name`), pour l'en-tête du billet.
 ...
 String? get qrCode; BookingStatus? get status; String get statusDisplay; bool get isBoarded; DateTime get createdAt;
...
@override
int get hashCode => Object.hashAll([runtimeType,id,ticketNumber,originCity,destinationCity,companyName,companySigle,departureTime,arrivalTime,passengerName,phone,seatNumber,const DeepCollectionEquality().hash(baggage),baggageTotalWeightKg,amount,paymentMethod,qrCode,status,statusDisplay,isBoarded,createdAt]);

@override
String toString() {
  return 'TravelerBooking(id: $id, ticketNumber: $ticketNumber, originCity: $originCity, destinationCity: $destinationCity, companyName: $companyName, companySigle: $companySigle, departureTime: $departureTime, arrivalTime: $arrivalTime, passengerName: $passengerName, phone: $phone, seatNumber: $seatNumber, baggage: $baggage, baggageTotalWeightKg: $baggageTotalWeightKg, amount: $amount, paymentMethod: $paymentMethod, qrCode: $qrCode, status: $status, statusDisplay: $statusDisplay, isBoarded: $isBoarded, createdAt: $createdAt)';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String ticketNumber,  String originCity,  String destinationCity,  String companyName,  String? companySigle,  DateTime departureTime,  DateTime? arrivalTime,  String passengerName,  String phone,  String seatNumber,  List<TravelerBaggageItem> baggage,  String? baggageTotalWeightKg,  String amount,  String? paymentMethod,  String? qrCode,  BookingStatus? status,  String statusDisplay,  bool isBoarded,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TravelerBooking() when $default != null:
return $default(_that.id,_that.ticketNumber,_that.originCity,_that.destinationCity,_that.companyName,_that.companySigle,_that.departureTime,_that.arrivalTime,_that.passengerName,_that.phone,_that.seatNumber,_that.baggage,_that.baggageTotalWeightKg,_that.amount,_that.paymentMethod,_that.qrCode,_that.status,_that.statusDisplay,_that.isBoarded,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String ticketNumber,  String originCity,  String destinationCity,  String companyName,  String? companySigle,  DateTime departureTime,  DateTime? arrivalTime,  String passengerName,  String phone,  String seatNumber,  List<TravelerBaggageItem> baggage,  String? baggageTotalWeightKg,  String amount,  String? paymentMethod,  String? qrCode,  BookingStatus? status,  String statusDisplay,  bool isBoarded,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _TravelerBooking():
return $default(_that.id,_that.ticketNumber,_that.originCity,_that.destinationCity,_that.companyName,_that.companySigle,_that.departureTime,_that.arrivalTime,_that.passengerName,_that.phone,_that.seatNumber,_that.baggage,_that.baggageTotalWeightKg,_that.amount,_that.paymentMethod,_that.qrCode,_that.status,_that.statusDisplay,_that.isBoarded,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
class _TravelerBooking extends TravelerBooking {
  const _TravelerBooking({required this.id, required this.ticketNumber, required this.originCity, required this.destinationCity, required this.companyName, this.companySigle, required this.departureTime, this.arrivalTime, required this.passengerName, required this.phone, required this.seatNumber, final  List<TravelerBaggageItem> baggage = const [], this.baggageTotalWeightKg, required this.amount, this.paymentMethod, this.qrCode, this.status, required this.statusDisplay, required this.isBoarded, required this.createdAt}): _baggage = baggage,super._();
...
@override
int get hashCode => Object.hashAll([runtimeType,id,ticketNumber,originCity,destinationCity,companyName,companySigle,departureTime,arrivalTime,passengerName,phone,seatNumber,const DeepCollectionEquality().hash(_baggage),baggageTotalWeightKg,amount,paymentMethod,qrCode,status,statusDisplay,isBoarded,createdAt]);
...
/// Create a copy of TravelerBooking
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? ticketNumber = null,Object? originCity = null,Object? destinationCity = null,Object? companyName = null,Object? companySigle = freezed,Object? departureTime = null,Object? arrivalTime = freezed,Object? passengerName = null,Object? phone = null,Object? seatNumber = null,Object? baggage = null,Object? baggageTotalWeightKg = freezed,Object? amount = null,Object? paymentMethod = freezed,Object? qrCode = freezed,Object? status = freezed,Object? statusDisplay = null,Object? isBoarded = null,Object? createdAt = null,}) {
