...
part of 'patched_company_settings.dart';
...
/// @nodoc
mixin _$PatchedCompanySettings {
...
@override
String toString() {
  return 'PatchedCompanySettings(name: $name, sigle: $sigle, description: $description, logo: $logo, banner: $banner, primaryColor: $primaryColor, welcomeMessage: $welcomeMessage, address: $address, phone: $phone, email: $email, responsibleName: $responsibleName, responsiblePhone: $responsiblePhone)';
}
...
/// @nodoc
abstract mixin class $PatchedCompanySettingsCopyWith<$Res>  {
  factory $PatchedCompanySettingsCopyWith(PatchedCompanySettings value, $Res Function(PatchedCompanySettings) _then) = _$PatchedCompanySettingsCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$PatchedCompanySettingsCopyWithImpl<$Res>
    implements $PatchedCompanySettingsCopyWith<$Res> {
  _$PatchedCompanySettingsCopyWithImpl(this._self, this._then);

  final PatchedCompanySettings _self;
  final $Res Function(PatchedCompanySettings) _then;

/// Create a copy of PatchedCompanySettings
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = freezed,Object? sigle = freezed,Object? description = freezed,Object? logo = freezed,Object? banner = freezed,Object? primaryColor = freezed,Object? welcomeMessage = freezed,Object? address = freezed,Object? phone = freezed,Object? email = freezed,Object? responsibleName = freezed,Object? responsiblePhone = freezed,}) {
...
/// Adds pattern-matching-related methods to [PatchedCompanySettings].
extension PatchedCompanySettingsPatterns on PatchedCompanySettings {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _PatchedCompanySettings value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _PatchedCompanySettings() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _PatchedCompanySettings value)  $default,){
final _that = this;
switch (_that) {
case _PatchedCompanySettings():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _PatchedCompanySettings value)?  $default,){
final _that = this;
switch (_that) {
case _PatchedCompanySettings() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$PatchedCompanySettingsCopyWith<_PatchedCompanySettings> get copyWith => __$PatchedCompanySettingsCopyWithImpl<_PatchedCompanySettings>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$PatchedCompanySettingsToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PatchedCompanySettings&&(identical(other.name, name) || other.name == name)&&(identical(other.sigle, sigle) || other.sigle == sigle)&&(identical(other.description, description) || other.description == description)&&(identical(other.logo, logo) || other.logo == logo)&&(identical(other.banner, banner) || other.banner == banner)&&(identical(other.primaryColor, primaryColor) || other.primaryColor == primaryColor)&&(identical(other.welcomeMessage, welcomeMessage) || other.welcomeMessage == welcomeMessage)&&(identical(other.address, address) || other.address == address)&&(identical(other.phone, phone) || other.phone == phone)&&(identical(other.email, email) || other.email == email)&&(identical(other.responsibleName, responsibleName) || other.responsibleName == responsibleName)&&(identical(other.responsiblePhone, responsiblePhone) || other.responsiblePhone == responsiblePhone));
}
...
/// @nodoc
abstract mixin class _$PatchedCompanySettingsCopyWith<$Res> implements $PatchedCompanySettingsCopyWith<$Res> {
  factory _$PatchedCompanySettingsCopyWith(_PatchedCompanySettings value, $Res Function(_PatchedCompanySettings) _then) = __$PatchedCompanySettingsCopyWithImpl;
@override @useResult
$Res call({
 String? name, String? sigle, String? description, String? logo, String? banner,@JsonKey(name: 'primary_color') String? primaryColor,@JsonKey(name: 'welcome_message') String? welcomeMessage, String? address, String? phone, String? email,@JsonKey(name: 'responsible_name') String? responsibleName,@JsonKey(name: 'responsible_phone') String? responsiblePhone
});
...
/// @nodoc
class __$PatchedCompanySettingsCopyWithImpl<$Res>
    implements _$PatchedCompanySettingsCopyWith<$Res> {
  __$PatchedCompanySettingsCopyWithImpl(this._self, this._then);

  final _PatchedCompanySettings _self;
  final $Res Function(_PatchedCompanySettings) _then;

/// Create a copy of PatchedCompanySettings
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = freezed,Object? sigle = freezed,Object? description = freezed,Object? logo = freezed,Object? banner = freezed,Object? primaryColor = freezed,Object? welcomeMessage = freezed,Object? address = freezed,Object? phone = freezed,Object? email = freezed,Object? responsibleName = freezed,Object? responsiblePhone = freezed,}) {
  return _then(_PatchedCompanySettings(
name: freezed == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String?,sigle: freezed == sigle ? _self.sigle : sigle // ignore: cast_nullable_to_non_nullable
as String?,description: freezed == description ? _self.description : description // ignore: cast_nullable_to_non_nullable
as String?,logo: freezed == logo ? _self.logo : logo // ignore: cast_nullable_to_non_nullable
